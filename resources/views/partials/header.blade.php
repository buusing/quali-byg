<div class="top-nav d-flex justify-content-between align-items-center py-3 px-2 px-lg-5">
  <a class="col" href="mailto:qb@quali-byg.dk"><i class="far fa-envelope" style="margin-right: 10px"></i>qb@quali-byg.dk</a>
  <a class="col text-center" href="tel:+4540357757"><i class="fas fa-phone fa-rotate-90" style="margin-right: 10px"></i>Man-Fre kl. 07.00-17.30</a>
  <div class="d-none d-lg-flex mb-0 col justify-content-end">
