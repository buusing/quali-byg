<div class="top-nav d-flex justify-content-between align-items-center py-3 px-2 px-lg-5">
  ...
  <p class="d-none d-lg-block mb-0"><a href="https://facebook.com" class="mr-2"><i class="fab fa-facebook fa-2x"></i></a><a href="https://instagram.com"><i class="fab fa-instagram fa-2x"></i></a></p>
</div>
